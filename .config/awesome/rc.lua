...
local scrlocker    = "/home/bjoern/.config/awesome/lock.sh"
...
globalkeys = my_table.join(
    ...
    -- X screen locker
    awful.key({ modkey, "Control" }, "l", function () os.execute("/home/bjoern/.config/awesome/lock.sh") end,
...
--[[    awful.key({ modkey,           }, "Tab",
    ...
    awful.key({ modkey }, "r", function ()
            os.execute("~/bin/rofi-launcher")
        end,
        {description = "show rofi", group = "launcher"}),
    awful.key({ modkey }, "Tab", function ()
            os.execute("~/bin/rofi-switcher")
...
--    { rule = { class = "slack", floating = true },
--      properties = { ontop = true, titlebars_enabled = true } },
